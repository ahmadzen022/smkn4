<template>
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
          <h5 class="text-white text-center rounded-3 p-2 m-3 bg-success">
            VISI & MISI
          </h5>
        </div>
        <div class="visimisi subcontent text-secondary">
                ...
                <p style="margin-top:40px;">
                <h5 class="text-center mb-5"><strong>Misi :</strong></h5>
                <ol start="1">
                ...
                <hr title="TUJUAN SMK" />
                <p style="margin-top:30px;">
                <h4 class="mb-5" style="text-align:center"><strong>Tujuan SMK Negeri 4 Tasikmalaya</strong></h4>
                </p>
